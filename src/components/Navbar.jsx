...
import { useLogoutUserMutation, useLoginUserMutation } from '../lib/services/auth';
          ...
          <div className='navbar-banner-main-innerdiv container d-flex'>
            ...
            <div className='navbar-banner-rightside d-flex gap-3'>
              ...
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                <i className="fa-brands fa-instagram fa-lg" style={{ color: "white" }}></i>
              </a>
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
                <i className="fa-brands fa-linkedin fa-lg" style={{ color: "white" }}></i>
              </a>
              <a href="https://github.com/vaibhav540/Democracy-Data_035" target="_blank" rel="noopener noreferrer">
          ...
          <div className="navbar-content container d-flex">
            <div className='navbar-icon d-flex'>
              <Link className="navbar-brand" to="/">
                <img src="https://masai-website-images.s3.ap-south-1.amazonaws.com/logo.png" alt="Bootstrap" width="120" height="42" />
              </Link>
            </div>
              ...
              {isAuth ? (
                <>
                  <Menu>
                    <MenuButton
                      as={IconButton}
                      aria-label="Options"
                      icon={<Avatar size={'sm'} src={'https://images.unsplash.com/photo-1619946794135-5bc917a27793?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=b616b2c5b373a80ffc9636ba24f7a4a9'} />}
                      variant="outline"
                    >
                      <HStack spacing={2}>
                ...
                <>
                  ...
                  <ButtonGroup spacing={4}>
                    <Button colorScheme='teal' variant='outline' color='white' borderColor='white' onClick={showLoginModal}>
                      Login
                    </Button>
                    <Button colorScheme='teal' variant='outline' color='white' borderColor='white' onClick={showRegistrationModal}>
                      Registration
                    </Button>
                  </ButtonGroup>
                </>
